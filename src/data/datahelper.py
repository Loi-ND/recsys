...
FEMALE_ONLY_ITEMS = [
    'Vest top', 'Bra', 'Underwear Tights', 'Leggings/Tights', 'Sweater',
    'Top', 'Pyjama jumpsuit/playsuit', 'Bodysuit', 'Hair clip', 'Hair string',
    'Hair/alice band', 'Bikini top', 'Swimwear bottom', 'Swimsuit', 'Skirt',
    'Dress', 'Cardigan', 'Earring', 'Bag', 'Jumpsuit/Playsuit', 'Sandals',
    'Robe', 'Scarf', 'Necklace', 'Ballerinas', 'Bracelet', 'Blouse',
    'Underwear body', 'Swimwear set', 'Swimwear top', 'Flat shoe', 'Wedge',
    'Pumps', 'Heeled sandals', 'Nipple covers', 'Hair ties', 'Underwear corset',
    'Bra extender', 'Underdress', 'Underwear set', 'Sarong', 'Leg warmers',
    'Hairband', 'Tote bag', 'Earrings', 'Headband', 'Baby Bib', 'Shoulder bag'
]

MALE_ONLY_ITEMS = [
    'Trousers', 'Shirt', 'Cap/peaked', 'Sneakers', 'Belt', 'Boots',
    'Blazer', 'Other shoe', 'Jacket', 'Coat', 'Polo shirt', 'Tailored Waistcoat',
    'Tie', 'Outdoor trousers', 'Long John', 'Outdoor Waistcoat', 'Braces',
    'Bootie', 'Flat shoes', 'Moccasins', 'Cap', 'Wallet', 'Watch'
]
...
class DataHelper:
    ...
    def __init__(self, data_dir: str, raw_dir: str = "raw"):
        ...
        self.raw_dir = "/kaggle/input/h-and-m-csv-dataset" # raw data directory
    ...
    def _base_features(self, data: dict) -> dict:
        ...
        # * Seasonal Articles
        item["season_type"] = 0
        item.loc[item["product_type_name"].isin(SUMMER_ITEMS), "season_type"] = 1
        item.loc[item["product_type_name"].isin(WINTER_ITEMS), "season_type"] = 2
